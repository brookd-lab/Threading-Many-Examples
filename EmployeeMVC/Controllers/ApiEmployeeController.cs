...
namespace EmployeeMVC.Controllers
{
    public class ApiEmployeeController : Controller
    {
        HttpClient _client;
        string _url;
        public ApiEmployeeController(IConfiguration config)
        {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var url = $@"{_url}/id?id={id}";
            // Consume API
            var employee = JsonConvert.DeserializeObject<Employee>(await _client.GetStringAsync(url));
